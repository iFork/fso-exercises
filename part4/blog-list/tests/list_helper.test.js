...
describe('total like', () => {
  ...
  test('list of blogs with different likes', () => {
...
describe('favorite blog', () => {
  ...
  test('list with one blog', () => {
    ...
    expect(list_helper.favoriteBlog(listWithOneBlog)).toEqual(expected);
  });
  test('list with many blog', () => {
    const expected = {
      title: 'Canonical string reduction',
      author: 'Edsger W. Dijkstra',
      likes: 12,
    };
    expect(list_helper.favoriteBlog(blogs)).toEqual(expected);
  });
});
...
describe('author of most blogs', () => {
  ...
  test('list with one blog', () => {
    ...
    expect(list_helper.mostBlogs(listWithOneBlog)).toEqual(expected);
  });
  test('list of many blogs', () => {
    ...
    expect(list_helper.mostBlogs(blogs)).toEqual(expected);
  });
});
...
describe('most liked author', () => {
  ...
  test('list with one blog', () => {
    ...
    expect(list_helper.mostLikes(listWithOneBlog)).toEqual(expected);
  });
  test('list of many blogs', () => {
    const expected = {
      author: 'Edsger W. Dijkstra',
